...
public class AddProjectServlet extends HttpServlet {
	...
	private static final String GLOBAL_ERROR = "Veuillez remplir tous les champs";
	private static final String PICTURE_ERROR = "Veuillez ajouter une image";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (form.getErrors().isEmpty()) {
			try {
				...
				resp.sendRedirect("/SupCrowdfunder/auth/addProject?error=" + GLOBAL_ERROR);
			}

		} else {
			resp.sendRedirect("/SupCrowdfunder/auth/addProject?error=" + PICTURE_ERROR);
			// this.getServletContext().getRequestDispatcher( VIEW ).forward( req, resp );
		}
